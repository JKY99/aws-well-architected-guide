...
export default function AppendixSus2Page() {
  return (
    <article className="doc-content">
      ...
      <ul>
        <li>
          <strong>SUS02-BP01:</strong> 사용자 행동 패턴에 따른 인프라 규모 조정<br />
          <span>Auto Scaling으로 실제 수요에 맞게 리소스를 자동 조정하여 유휴 용량을 줄입니다.</span>
        </li>
        <li>
          <strong>SUS02-BP02:</strong> SLA를 사용 패턴에 맞게 정렬<br />
          <span>실제 필요한 수준의 가용성과 성능 SLA를 설정하여 과도한 리소스 프로비저닝을 방지합니다.</span>
        </li>
        <li>
          <strong>SUS02-BP03:</strong> 미사용 자산, 리소스, 서비스 제거<br />
          <span>정기적으로 유휴 리소스를 식별하고 제거하여 불필요한 에너지 소비를 줄입니다.</span>
        </li>
        <li>
          <strong>SUS02-BP04:</strong> 비활성 기간에 리소스 종료<br />
          <span>개발/테스트 환경을 비업무 시간에 자동으로 종료하여 에너지 사용을 절감합니다.</span>
        </li>
        <li>
          <strong>SUS02-BP05:</strong> 완전히 활용되는 서비스를 선택하는 IaC 사용<br />
